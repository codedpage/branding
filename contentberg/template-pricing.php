                        ...
                        <div class="basic box">
                           <div class="view">
                              ...
                              <?php
                                 ...
                                 ?>
                              <p class="saving" style="display:none" id="save_percentage_<?=$value->pricing_name?>">Save $120</p>
                              <?php
                                 }
                                 ?>
                              ...
                              <table class="pricing-table">
                                 <tbody>
                                    <tr class="pricing-table-list table-acc">
                                       ...
                                       <td class="bg_color2 tds1"><span class="glyphicon glyphicon-ok"></span></td>
                              ...
                              <table class="pricing-table">
                                 <tbody>
                                    ...
                                    <tr class="pricing-table-list table-acc">
                                       ...
                                       <td class="bg_color2 tds3"><span class="glyphicon glyphicon-ok"></span></td>
