<?php /* Template Name: Live Video Meetings Calendar Test*/ ?>
...
<style>
    ...
    *, ::after, ::before {
    ...
    .side-green-button a:hover{
        background: #fff;
        color: #6faf73;
        border: 1px solid #6faf73;
        transform: scale(1.1);
    }
    ...
    select.fellowshipDropDown:focus {
...
<script type="text/javascript">
    ...
    function changeTimeZone(timeZone) {
        $.ajax({
            ...
            data: {
                'action': 'live_video_meetings_calendar_test',
                'timeZone' : timeZone,
                '_nonce': '<?php echo md5('live_video_meetings_calendar_test')?>',
            },
