...
?>
<form class="my-frm" method="post" id="payment-form" action="<?php echo get_home_url();?>/directory-subscription/?type=platinum" enctype="multipart/form-data">
<div class="container-my">
	<div class="package-frm">
	<div class="row-my">
	<div class="col-12-my m-10">
		<h3 class="frm-top-hding" style="margin-top:20px;">Add a Platinum Listing</h3><hr class="divider-line">
		<?php
                if (isset($_POST['doc_name'])) {
                    ...
                    if(count($reg_errors->errors) == 0) {
                            ...
                            $thanks_html = '
                                    ...
                                    <div class="col-12-my">
                                        ...
                                        <p><b>Platinum Listing Monthly Subscription</b><br>$69.00 today, then $69.00/month<br>Your subscription will continue until cancelled.<br><br>Total: $69.00</p>
                                    </div>
                                    <div class="col-12-my">
